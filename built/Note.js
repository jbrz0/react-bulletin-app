var Note = React.createClass({
	...
	renderForm: function () {
		return React.createElement(
			...
			React.createElement('button', { onClick: this.save, className: 'btn btn-primary btn-save glyphicon glyphicon-floppy-disk' })
		);
	},
...
var Board = React.createClass({
	...
	render: function () {
		return React.createElement(
			...
			React.createElement('button', { className: 'btn btn-lg glyphicon glyphicon-plus',
